...
var exceptionsList = require('./exceptions.json');

var exclude = []
for (var word in exceptionsList) {
  exclude = exclude.concat(exceptionsList[word])
}
console.log('final length of exclude: ' + exclude.length);
...
var Filter = (function() {
  ...
  function Filter(options) {
    ...
    this.exclude = options.exclude || exclude;
